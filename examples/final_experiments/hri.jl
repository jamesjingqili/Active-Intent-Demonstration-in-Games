...
plot(0:game_horizon-1, list_active_costs_player_2,linewidth = line_width,color=active_color, xlabel="",label="",legend=:topright,fillalpha=filled_alpha)
plot!(0:game_horizon-1, list_passive_costs_player_2,linewidth = line_width, color = passive_color, xlabel="", ylabel="",label="",fillalpha=filled_alpha)
plot!(0:game_horizon-1, list_complete_costs_player_2,linewidth = line_width, color = complete_color, xlabel="", ylabel="",label="",fillalpha=filled_alpha)
plot!(size = (400,200), grid = false, leftmargin = 30px)
yaxis!(linewdith = 2)
xaxis!(linewdith = 2)
...
plot(0:game_horizon-1, active_belief_list, ribbon=active_var_list, xlabel="", ylabel="",label="", color=active_color, linewidth=line_width,fillalpha=filled_alpha)
plot!(0:game_horizon-1, passive_belief_list, ribbon=passive_var_list, xlabel="", ylabel="",label="",legend=:bottomright, color=passive_color,linewidth=line_width,fillalpha=filled_alpha)
plot!([0,game_horizon-1],[θ, θ],label="",color=:black, linewidth=line_width)
plot!(size = (400,200), grid = false, leftmargin = 30px)
yaxis!(linewdith = 2)
xaxis!(linewdith = 2)
...
plot(0:game_horizon-1, [x2_list[t][3] for t in 1:game_horizon], xlabel="", ylabel="", label="", color=active_color,linewidth=line_width) # active teaching   label="ours", 
plot!(0:game_horizon-1, [x3_list[t][3] for t in 1:game_horizon], xlabel="", ylabel="", label="", legend=:bottomright, color=passive_color, linewidth=line_width) # passive teaching   label="passive",
plot!(0:game_horizon-1, [x_list[t][3] for t in 1:game_horizon], xlabel="", ylabel="", label="", legend=:bottomright, color=complete_color, linewidth=line_width) # complete information  label="complete",
plot!([0,game_horizon-1],[θ,θ],label="",color=:black, linewidth=line_width) # θ*
plot!(size = (400,200), legend=:topright, grid = false, leftmargin = 30px)
yaxis!(linewdith = 2)
xaxis!(linewdith = 2)
